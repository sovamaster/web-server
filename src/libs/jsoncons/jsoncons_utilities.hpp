...
public:
	...
	*/
	...
	basic_byte_string(const basic_byte_string& s);

	basic_byte_string(basic_byte_string&& s);

	basic_byte_string& operator=(const basic_byte_string& s);

	basic_byte_string& operator=(basic_byte_string&& s);
